...
#zapis jako pdf. UWAGA - wymiary specjalnie mniejsze niz kartka a4.
#Po wydrukowaniu pojawia sie 1cm marginesy z kazdej strony. (wyglad pliku nie oddaje wygladu samej wizytowki)
